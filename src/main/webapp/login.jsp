...
<head>
    ...
    <style>
        ...
        /* ===== GLOBAL FLOATING SHAPES (NOW SEAMLESS) ===== */
        .shape {
            position: fixed;
            border-radius: 50%;
            opacity: 0.15;
        ...
        .shape1 { width: 300px; height: 300px; background: #ffffff; top: -80px; left: -80px; }
        .shape2 { width: 200px; height: 200px; background: #ffffff; bottom: 60px; right: -60px; animation-duration: 18s; }
        .shape3 { width: 150px; height: 150px; background: #ffffff; top: 40%; left: 55%; animation-duration: 20s; }
...
<!-- GLOBAL FLOATING SHAPES (Outside Grid for Seamless Effect) -->
        ...
        <div class="col-lg-6 d-none d-lg-flex auth-left align-items-center justify-content-center p-5 text-white text-center">
            ...
            <div>
                ...
                <p class="lead">
                    ...
                    Manage your books efficiently with our portal.
                </p>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-6 d-flex align-items-center justify-content-center p-4 auth-right">
            ...
            <div class="card auth-card shadow-lg p-5 fade-slide w-100" style="max-width: 420px;">
                ...
                <div class="text-center mb-4">
                    ...
                    <h5 class="fw-bold mt-2 text-primary">
